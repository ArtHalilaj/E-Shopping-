      ...
      <Col md={3}>
        ...
        <Form onSubmit={submitHandler}>
          ...
          <Form.Group className='my-2' controlId='confirmPassword'>
            <Form.Label>Konfirmo Passwordin</Form.Label>
            <Form.Control
              type='password'
          ...
          <Button style={{width:'100%',backgroundColor:'#24a0ed',border:'#37B34B'}} type='submit' variant='primary'>
            Update
          </Button>
